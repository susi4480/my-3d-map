# -*- coding: utf-8 -*-
"""
.las のみで法線推定し、床(法線Z>0.9)を除外 → .xyzと統合 → XY出力（Z下限なし）
"""
...
output_path = r"C:\Users\user\Documents\lab\output_ply\combined_xy_filtered.xyz"
