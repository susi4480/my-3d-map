...
# === 設定 ===
input_las_path = r"/data/matome/0821_suidoubasi_floor_ue.las"  # 補間済み川底LAS
lidar_xyz_dir = r"/data/matome/0821_merged_lidar_ue.las"       # LiDAR統合LAS
output_las_path = r"/output/0828_01_500_suidoubasi_ue.las"
voxel_size = 0.1
