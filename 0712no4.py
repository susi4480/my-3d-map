...
# === 入出力設定 ===
INPUT_DIR   = r"C:\Users\user\Documents\lab\output_ply\slice_area"
OUTPUT_DIR  = r"C:\Users\user\Documents\lab\output_ply\slice_area_navigation"
...
def process_file(input_path, output_path):
    ...
    logging.info(f"✅ 出力: {os.path.basename(output_path)}")
