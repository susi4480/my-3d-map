...
output_las_path = r"/output/0821_suidoubasi_ue.las"
...
# === 法線推定パラメータ（ここを自由に変更）===
search_radius = 0.5      # 半径（例：0.5m）
max_neighbors = 50       # 近傍点数（例：50）
...
# === [4] 法線推定と分類 ===
print(f"📐 法線推定中...（半径: {search_radius}m / 近傍点数: {max_neighbors}）")
