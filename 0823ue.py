...
# === 入出力設定 ===
floor_las_path = r"/output/0821_suidoubasi_floor_ue.las"  # 補間済み川底LAS
lidar_las_path = r"/data/0821_merged_lidar_ue.las"         # LiDAR統合LAS
output_las_path = r"/output/0823full_ue_suidoubasi__classified.las"

# === 分類パラメータ ===
normal_wall_z_max = 3.2         # 壁とビルの境界高さ
floor_z_max = 1.1               # 床の上限高さ
horizontal_threshold = 0.5      # 床判定の法線Zしきい値
vertical_threshold = 0.3        # 壁判定の法線Zしきい値

# === 法線推定パラメータ ===
search_radius = 1.0             # 法線推定の近傍半径
max_neighbors = 500              # 法線推定の最大近傍点数
