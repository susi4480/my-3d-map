# -*- coding: utf-8 -*-
"""
【機能（M0 on M5 スタイル, 修正版）】
- 入力LASをM5と同じくスライス化（中心線に沿って直線的に配置）
- 各スライスで v–z occupancy を作成
- occupancy からM0方式で「最大長方形＋それに直接接している長方形」を結合
- 最後にひとつの大きな長方形の外周セルを点群化して保存
"""
...
OUTPUT_LAS = r"/output/1013no1_M0onM5_maxrect_only.las"
...
def main():
    ...
    for i in range(len(centers)-1):
        ...
        rect_edges_vz, _bbox = rectangles_on_slice_M0(
