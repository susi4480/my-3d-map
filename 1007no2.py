# -*- coding: utf-8 -*-
"""
【機能】M0 on M5統合版（スライスごとに個別LAS出力, 長方形結合方式）
---------------------------------------------------------
- 入力LASをM5方式で中心線に沿ったスライスを生成
- 各スライスで v–z occupancy を構築
- M0方式で最大長方形＋直接接している長方形を結合
...
# ===== 入出力 =====
INPUT_LAS  = "/data/0925_ue_classified.las"
OUTPUT_DIR = "/output/1007no2_m0onm5_slices"
...
def main():
    ...
    print(f"🎉 スライス出力完了: {len(os.listdir(OUTPUT_DIR))}ファイル")
